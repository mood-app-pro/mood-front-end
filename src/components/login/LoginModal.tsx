      ...
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-xs relative">
        ...
        <div className="space-y-3">
          <button className="w-full bg-blue-600 text-white py-2 rounded flex items-center justify-start text-sm px-4">
            <Image
              src="/images/icons/icons-facebook.svg"
              width={24}
              height={24}
              alt="Facebook"
              className="mr-2"
          ...
          <button className="w-full bg-yellow-950 text-white py-2 rounded flex items-center justify-start text-sm px-4">
            <Image
              src="/images/icons/icons-phone.svg"
              width={24}
              height={24}
              alt="Phone"
              className="mr-2"
          ...
          <button className="w-full bg-gray-800 text-white py-2 rounded flex items-center justify-start text-sm px-4">
            <Image
              src="/images/icons/icons-apple.svg"
              width={24}
              height={24}
              alt="Apple"
              className="mr-2"
        ...
        <div className="text-center text-sm mt-6">
          ...
          <div className="flex justify-center space-x-4 mt-2">
            <Link href="#" className="text-gray-600 hover:text-gray-800">
              <Image
                src="/images/icons/icons-line.svg"
                width={24}
                height={24}
                alt="Facebook"
              />
            ...
            <Link href="#" className="text-gray-600 hover:text-gray-800">
              <Image
                src="/images/icons/icons-twitterx.svg"
                width={24}
                height={24}
                alt="Twitter"
              />
            ...
            <Link href="#" className="text-gray-600 hover:text-gray-800">
              <Image
                src="/images/icons/icons-tik-tok.svg"
                width={24}
                height={24}
                alt="Tiktok"
              />
            ...
            <Link href="#" className="text-gray-600 hover:text-gray-800">
              <Image
                src="/images/icons/icons-instagram.svg"
                width={24}
                height={24}
                alt="Instagram"
              />
